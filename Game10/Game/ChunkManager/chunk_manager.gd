...
var _textures = [
	preload("res://Game10/Game/BlockTextures/stone.png"),			# 0
	preload("res://Game10/Game/BlockTextures/dirt.png"),			# 1
	preload("res://Game10/Game/BlockTextures/grass.png"),			# 2
	preload("res://Game10/Game/BlockTextures/grass_side.png"),		# 3
	preload("res://Game10/Game/BlockTextures/water.png"),			# 4
	preload("res://Game10/Game/BlockTextures/sand.png"),			# 5
	preload("res://Game10/Game/BlockTextures/oak_log.png"),		# 6
	preload("res://Game10/Game/BlockTextures/oak_log_top.png"),	# 7
	preload("res://Game10/Game/BlockTextures/oak_leaves.png"),		# 8
	preload("res://Game10/Game/BlockTextures/oak_planks.png"),		# 9
	preload("res://Game10/Game/BlockTextures/torch.png"),			# 10
	]
...
var _chunks = {}
var _chunk_scene = preload("res://Game10/Game/Chunk/chunk.tscn")
