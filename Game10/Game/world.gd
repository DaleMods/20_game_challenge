...
var chunk_manager_scene = preload("res://Game10/Game/ChunkManager/chunk_manager.tscn")
var player_scene = preload("res://Game10/Game/Player/player.tscn")
var ui_scene = preload("res://Game10/Game/UI/ui.tscn")
